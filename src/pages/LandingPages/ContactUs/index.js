...
function ContactUs() {
  ...
  const fetchQuestion = async () => {
    try {
      ...
      const response = await fetch("/mbti/test/personal/question"); // Replace "/api/question" with the actual API endpoint
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post("http://localhost:3000//mbti/test/personal/answer", { answer }); // Replace "/api/answer" with the actual API endpoint
